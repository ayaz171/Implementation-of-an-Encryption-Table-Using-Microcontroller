# 1 "H:\\sketch_sep15a\\sketch_sep15a.ino"
int O0 = 10;
int O1 = 11;
int O2 = 12;
int O3 = 13;
...
void setup()
{
pinMode(I0,0x0); pinMode(I1,0x0); pinMode(I2,0x0); pinMode(I3,0x0); pinMode(O0,0x1); pinMode(O1,0x1); pinMode(O2,0x1); pinMode(O3,0x1);
}
...
{digitalWrite(O0,0x0) ; digitalWrite(O1,0x1) ; digitalWrite(O2,0x0) ; digitalWrite(O3,0x1);

}

if (digitalRead(I0) == 0 && digitalRead(I1) == 0 && digitalRead(I2) == 0 && digitalRead(I3) == 1)
{digitalWrite(O0,0x1) ; digitalWrite(O1,0x1) ; digitalWrite(O2,0x0) ; digitalWrite(O3,0x0);

} if (digitalRead(I0) == 0 && digitalRead(I1) == 0 && digitalRead(I2) == 1 && digitalRead(I3) == 0)
{digitalWrite(O0,0x1) ; digitalWrite(O1,0x0) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x0);

} if (digitalRead(I0) == 0 && digitalRead(I1) == 0 && digitalRead(I2) == 1 && digitalRead(I3) == 1)
{digitalWrite(O0,0x0) ; digitalWrite(O1,0x1) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x0);

} if (digitalRead(I0) == 0 && digitalRead(I1) == 1 && digitalRead(I2) == 0 && digitalRead(I3) == 0)
{digitalWrite(O0,0x1) ; digitalWrite(O1,0x0) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x1);
...
{digitalWrite(O0,0x0) ; digitalWrite(01,0x1) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x0);
...
{digitalWrite(O0,0x0) ; digitalWrite(O1,0x0) ; digitalWrite(O2,0x0) ; digitalWrite(O3,0x1);

} if (digitalRead(I0) == 1 && digitalRead(I1) == 0 && digitalRead(I2) == 0 && digitalRead(I3) == 1)
{digitalWrite(O0,0x0) ; digitalWrite(O1,0x0) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x1);
...
{digitalWrite(O0,0x0) ; digitalWrite(O1,0x1) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x1);

} if (digitalRead(I0) == 1 && digitalRead(I1) == 1 && digitalRead(I2) == 1 && digitalRead(I3) == 0)
{digitalWrite(O0,0x0) ; digitalWrite(O1,0x0) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x0);

} if (digitalRead(I0) == 1 && digitalRead(I1) == 1 && digitalRead(I2) == 1 && digitalRead(I3) == 1)
{digitalWrite(O0,0x1) ; digitalWrite(O1,0x1) ; digitalWrite(O2,0x1) ; digitalWrite(O3,0x0);
